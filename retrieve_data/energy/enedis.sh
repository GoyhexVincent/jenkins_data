...
psql -U oryx -d debian_db -p 5432 -c "CREATE SCHEMA IF NOT EXISTS energie;"
psql -U oryx -d debian_db -p 5432 -c "DROP TABLE IF EXISTS energie.enedis_daily_client_consumption;"
psql -U oryx -d debian_db  -p 5432 -c "CREATE TABLE energie.enedis_daily_client_consumption(
    date varchar, 
    categorie_client varchar,
    puissance_moyenne_journaliere float);"
psql -U oryx -d debian_db -p 5432 -c "\COPY energie.enedis_daily_client_consumption FROM 'enedis_daily_client_consumption.csv' WITH DELIMITER AS ';' CSV HEADER ENCODING 'WIN1252';"
...
psql -U oryx -d debian_db -p 5432 -c "DROP TABLE IF EXISTS energie.enedis_epci_electric_production;"
psql -U oryx -d debian_db  -p 5432 -c "CREATE TABLE energie.enedis_epci_electric_production(
    date varchar, 
    nom_EPCI varchar,
    code_EPCI varchar,
    type_EPCI varchar,
...
psql -U oryx -d debian_db -p 5432 -c "\COPY energie.enedis_epci_electric_production FROM 'enedis_epci_electric_production.csv' WITH DELIMITER AS ';' CSV HEADER ENCODING 'WIN1252';"
...
psql -U oryx -d debian_db -p 5432 -c "DROP TABLE IF EXISTS energie.enedis_department_electric_production;"
psql -U oryx -d debian_db  -p 5432 -c "CREATE TABLE energie.enedis_department_electric_production(
    date varchar, 
    departement varchar,
...
psql -U oryx -d debian_db -p 5432 -c "\COPY energie.enedis_department_electric_production FROM 'enedis_department_electric_production.csv' WITH DELIMITER AS ';' CSV HEADER ENCODING 'WIN1252';"
...
psql -U oryx -d debian_db -p 5432 -c "DROP TABLE IF EXISTS energie.enedis_region_electric_production;"
psql -U oryx -d debian_db  -p 5432 -c "CREATE TABLE energie.enedis_region_electric_production(
    date varchar, 
    region varchar,
    code_region smallint,
    domaine_de_tension varchar,
...
psql -U oryx -d debian_db -p 5432 -c "\COPY energie.enedis_region_electric_production FROM 'enedis_region_electric_production.csv' WITH DELIMITER AS ';' CSV HEADER ENCODING 'WIN1252';"
